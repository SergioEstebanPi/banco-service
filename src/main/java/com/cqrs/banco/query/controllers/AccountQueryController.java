package com.cqrs.banco.query.controllers;

import com.cqrs.banco.query.dto.AccountWatchEvent;
import com.cqrs.banco.query.entities.Account;
import com.cqrs.banco.query.queries.GetAccountById;
import com.cqrs.banco.query.queries.GetAllAccounts;
...
public class AccountQueryController {
    ...
    public CompletableFuture<Account> listarCuentaPorId(@PathVariable String id){
        return queryGateway.query(new GetAccountById(id),
